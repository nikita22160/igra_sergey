...
public class PlayerController : MonoBehaviour
{
	...
	private void OnTriggerEnter2D(Collider2D coll)
	{
		...
		if (coll.gameObject.tag == "Pizza")
		{
			coins = coins - 1;
			{
				if (coins <= 0) //Если кол-во жизни меньше или равно 0
				{
					coins = 0; //Ставим 0 дабы наш бар не рисовался не корректно
					wins = true; //Ставим что персонаж мертв
